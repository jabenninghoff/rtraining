...
`r packageDescription("rtraining", fields = "Description")` The package is currently not yet fully functional, but you can read my [R Training Log](notebooks/r-training-log.Rmd) and [R Setup Log](notebooks/r-setup-log.Rmd) using the GitHub Pages URL: <https://jabenninghoff.github.io/rtraining/>.
