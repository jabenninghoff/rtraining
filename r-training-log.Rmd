...
- R Markdown demo notebook (`demo-notebook.Rmd`): [R Notebook](demo-notebook.nb.html)
- `knitr-spin.R` demo script: [knitr-spin.R](knitr-spin.nb.html) (from <https://yihui.org/knitr/demo/stitch/>)
