...
library(rlang)
library(promises)
library(future) # nolint: unused_import_linter. used for future_promise().
...
Answer: reviewing Google results for [R bound symbol](https://rlang.r-lib.org/reference/env_names.html) and [R promise object](https://rstudio.github.io/promises/articles/overview.html), construct the following code:
