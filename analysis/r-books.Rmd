...
- [R Markdown: The Definitive Guide](https://yihui.org/rmarkdown/) - written by the author
  of [knitr](https://yihui.org/knitr/)
- [R Markdown Cookbook](https://yihui.org/rmarkdown-cookbook/) - the follow-up to *The
  Definitive Guide*
