...
Hadley advocates for "tidy" data, but there are times when data is usefully [non-tidy](https://simplystatistics.org/posts/2016-02-17-non-tidy-data/).
...
```{r wikipedia_demo}
# nolint start: commented_code_linter, object_name_linter
local({
