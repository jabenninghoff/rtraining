...
Polygon maps are superseded by simple features maps, but the `sf` package requires too many dependencies to justify installation for only drawing a simple map.
